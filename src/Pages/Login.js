...
export default function Login() {
    ...
    return (
        <>
            <section className="vh-100" style={{"marginTop": "6rem", "position": "relative", "zIndex": "0"}}>
                    ...
                    <div className="row d-flex justify-content-center align-items-center h-100">
                        ...
                        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                            <form onSubmit={loginUser}>
                                ...
                                <h1 className="divider d-flex align-items-center my-4" style={{"color": "#ff8d1e"}}>Login</h1> <br />
                                {/* Email input */}
                                <div className="form-outline mb-3">
                                    <input type="text" value={rollNo} onChange={(e)=>setRollNo(e.target.value)} id="form3Example3" className="form-control form-control-lg" placeholder="Enter your roll number" required/>
                                </div>
                                {/* Password input */}
                                ...
                                <div className="text-center text-lg-start mt-4 pt-2">
                                    <button type="submit" className="btn btn-lg" style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' , "backgroundColor" : "#ff8d1e"}}>Login</button>
                                </div>
                            </form>
                        </div>
